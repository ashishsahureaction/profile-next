      ...
      <header className={`${scrolling ? 'border-b border-gray-900' : ''}  fixed left-0 right-0 top-0 z-20`} id="home">
        <div className="container m-auto px-4 py-6 max-w-4xl bg-black">
          <div className="flex flex-col gap-4 sm:flex-row justify-between items-center">
            <div>
              <h1 className="font-bold text-2xl">Ashish Portfolio</h1>
            </div>
            <div>
      ...
      <main className="relative mt-28">
        ...
        <section>
          <div className="container m-auto px-4 pt-12 pb-12 sm:pt-20 flex flex-col sm:flex-row gap-6 text-center sm:text-left">
            <div>
              <h2 className="font-bold text-4xl">Hello, I'm Ashish,</h2>
              <div>
                <h2 className="font-bold text-4xl mt-1 gradiant-text">Senior Full Stack Developer</h2>
              </div>
              <div>
                <p className="mt-4 text-gray-400">
                  A Full Stack developer, seeking to apply
          ...
          <div className="container m-auto px-4">
            ...
            <div className="mt-12 relative before:absolute before:top-0 before:left-16 before:rounded-full before:bottom-10 sm:before:bottom-2 before:w-1 before:bg-white">
              <div className="pl-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                <h3 className="absolute left-0 text-lg font-semibold">2009</h3>
                <p>
                "I completed my studies in India and subsequently worked for over 7 years as a Circle Manager at a Bank ."
                </p>
              </div>
              <div className="pl-24 mt-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                <h3 className="absolute left-0 text-lg font-semibold">2015</h3>
                <p>
                "Growing interest in IT led me to explore programming. After completing a JavaScript course,
                 I developed a project and transitioned to a career in IT."
                </p>
              </div>
              <div className="pl-24 mt-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                <h3 className="absolute left-0 text-lg font-semibold">2016</h3>
                <p>
                  Moved to Canada, and started carrier with Futrure Genrali Health Inc. Became more interested in IT and decided to learn more.
                  Underwent Front End development courses and made several projects.
                </p>
              </div>
              <div className="pl-24 mt-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                <h3 className="absolute left-0 text-lg font-semibold">2015</h3>
                <p>
                  ...
                  and started to learn Full Stack Development.
                </p>
              </div>
            </div>
          </div>
